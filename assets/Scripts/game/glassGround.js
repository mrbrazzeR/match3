...
cc.Class({
    ...
    initGroundView: function() {
        ...
        for (var n = 0; n < psconfig.matrixRow; n++) {
    ...
    loadMapRes: function(e, t) {
        for (var i = 0; i < e.length; i++){
            var s = e[i], a = s[0][0], o = s[1][0], c = s[0][1], r = s[1][1], d = s[2]
            for (var l = a; l <= o; l++){
                for (var h = c; h <= r; h++){
    ...
    loadSquirrelStatue: function(e) {
        for (var t = 0; t < e.length; t++) {
            var i = e[t]
            var s = cc.instantiate(this.squirrel)
            var n = s.getComponent("squirrel");
            n.initBearData(i);
    ...
    removeSingleGrass: function(e) {
        var t = e.pos
        var i = utils.indexValue(t.x, t.y);
    ...
    releaseSquirreStatue: function() {
        if (this.squirrelNodeList && this.squirrelNodeList.length > 0) {
            // Loop through the list and remove each node from its parent
